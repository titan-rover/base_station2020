...
img_file = Image.open("D5.jpg")

color_region = img_file.crop((1350, 300, 550+1200, 400+300))
color_region.save("color_region5.jpg")
image = cv2.imread("color_region5.jpg")
...
cv2.imwrite('cropped5.jpg',ROI)
cv2.waitKey()
img_for_graph = Image.open("cropped5.jpg")
