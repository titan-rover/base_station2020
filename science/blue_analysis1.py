...
spec_sample.save("spec_sample_1.png")
image = cv2.imread("spec_sample_1.png")
...
cv2.imshow('Cropped #1',ROI)
cv2.imwrite('crop_spec_sample_1.png',ROI)
cv2.waitKey()
crop_spec_sample = Image.open("crop_spec_sample_1.png")
