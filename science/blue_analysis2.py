...
spec_sample.save("spec_sample_2.jpg")
image = cv2.imread("spec_sample_2.jpg")
...
cv2.imwrite('crop_spec_sample_2.jpg',ROI)
cv2.waitKey()
crop_spec_sample = Image.open("crop_spec_sample_2.jpg")
