...
public:
    ...
    void retranslateUi(QWidget *oneCamera)
    {
        ...
        clockwiseButton->setText(QApplication::translate("oneCamera", "Clockwise", nullptr));
        counterClockwiseButton->setText(QApplication::translate("oneCamera", "Counterclockwise", nullptr));
