...
QT_MOC_LITERAL(1, 10, 11), // "sendImuData"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 4), // "roll"
QT_MOC_LITERAL(4, 28, 5) // "pitch"

    },
    "ImuThread\0sendImuData\0\0roll\0pitch"
};
...
void ImuThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendImuData((*reinterpret_cast< float(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ImuThread::*)(float , float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImuThread::sendImuData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ImuThread::sendImuData(float _t1, float _t2)
{
